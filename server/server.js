...
app.use('/api', [ users, districts, cities ]);
  ...
  return `
    ...
    <html style="height: 100%" }} >
      <head>
        ...
        <script src='./util/nprogress.js'></script>
        <link rel='stylesheet' href='./util/nprogress.css'/>
      </head>
      <body style="height: 100%"  >
        <div id="root" style="height: 100%" }} ><div style="min-height: 100%" >${html}</div></div>
        <script>
...
let serverSocketIOObj = new serverSocketIO(server);
